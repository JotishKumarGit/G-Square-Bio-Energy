...
<body id="home">
    ...
    <div class="breadcrumb-container">
        <ul class="breadcrumb">
            ...
            <li class="active"><a href="#">Indian Coal</a></li>
        </ul>
    </div>
    ...
    <section class="imported-coal-section">
        <div class="imported-coal-card">
            ...
            <div class="imported-coal-image">
                <img src="images/Indian-Coal.jpg" alt="Indian Coal">
            </div>
            ...
            <div class="imported-coal-details">
                ...
                <p>
                    Indian Coal is widely used thermal coal known for its reliable availability
                    and cost-effective performance. It provides consistent heat output and is
                    suitable for various industrial and power generation applications across India.
                </p>

                <p><strong>Origin:</strong> India</p>
                <p><strong>Grade:</strong> Medium to High Calorific Value</p>
                <p><strong>Usage:</strong> Power plants, cement industries, brick kilns, boilers</p>
